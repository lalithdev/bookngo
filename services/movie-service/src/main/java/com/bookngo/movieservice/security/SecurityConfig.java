...
import com.bookngo.movieservice.dto.ErrorResponse;
    ...
    public AuthenticationEntryPoint authenticationEntryPoint() {
        return (request, response, authException) -> {
            ...
            ErrorResponse errorResponse = ErrorResponse.builder()
                    ...
                    .code("UNAUTHORIZED")
                    .message(authException.getMessage() != null ? authException.getMessage() : "Missing or invalid authentication token")
